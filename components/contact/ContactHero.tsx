    ...
    return (
      ...
      "
        >
            ...
            {/* LIGHT MODE BLOBS */}
            <div className="absolute top-1/3 left-1/4 h-80 w-80 rounded-full bg-pink-300/40 blur-[120px] dark:hidden" />
            <div className="absolute bottom-1/4 right-1/4 h-80 w-80 rounded-full bg-cyan-300/40 blur-[120px] dark:hidden" />

            {/* DARK MODE BLOBS */}
            <div className="hidden dark:block absolute top-1/4 left-1/4 h-96 w-96 rounded-full bg-fuchsia-600/20 blur-[140px]" />
      ...
      " />
          ...
          ">
                        <span className="
              bg-gradient-to-r
              from-fuchsia-600 via-pink-500 to-indigo-500
              dark:from-fuchsia-400 dark:via-pink-500 dark:to-cyan-400
          ...
          ">
                        ...
                        We design, build, and scale experiences that actually perform.
                    </p>
                </motion.div>
            </motion.div>
        </section>
